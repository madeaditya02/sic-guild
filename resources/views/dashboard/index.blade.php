...
<body>
  <header class="flex justify-between items-center px-6 md:px-25 py-6 sticky top-0 bg-white flex-wrap md:flex-nowrap z-30">
    ...
    <div class="auth-group relative items-center gap-2 font-nunito w-full md:w-auto shrink-0 mt-5 md:mt-0 cursor-pointer">
      <img src="/assets/user.jpg" alt="" class="size-8 rounded-full object-cover">
      <p>Deasa Putra</p>
      <div class="auth-menu w-60 rounded-lg shadow-lg absolute top-full md:right-0 border border-[#ddd] mt-2 bg-white">
        <a href="/dashboard" class="block w-full text-left cursor-pointer px-4 py-2 hover:bg-[#efefef]">Dashboard</a>
        <button class="block w-full text-left cursor-pointer px-4 py-2 hover:bg-[#efefef]">Logout</button>
      </div>
    </div>
  </header>
  ...
  <main class="font-nunito">
    <section class="mt-8 px-6 md:px-25">
      ...
      <a href="/dashboard/create" class="inline-flex gap-2 px-3 py-2 rounded-lg bg-primary border border-primary text-white hover:bg-primary-300">
