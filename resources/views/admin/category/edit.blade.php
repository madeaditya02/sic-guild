    ...
    <section class="mt-8 px-6 md:px-25">
      ...
      <form action="" class="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div class="col-span-full">
          ...
          <input type="file" name="icon" id="icon" class="block w-full px-3 py-2 border border-[#dddddd] rounded-lg file:bg-primary file:px-2 file:py-1 file:rounded-lg file:text-white file:mr-3">
          <p class="mt-1 text-xs text-gray-400">Leave empty to keep the current icon</p>
        </div>
        <div class="col-span-full">
          <label for="description">Description</label>
          <textarea name="description" id="description" rows="4" class="block w-full mt-2.5 px-5 py-3 border border-[#dddddd] rounded-lg" placeholder="Write a short description">Stories about careers, productivity, and the changing nature of work in the modern world.</textarea>
        </div>
        <div>
