...
<body>
  <header class="flex justify-between items-center px-6 md:px-25 py-6 sticky top-0 bg-white flex-wrap md:flex-nowrap z-30">
    ...
    <nav class="nav-menu show md:items-center gap-6 font-nunito bg-white w-full md:w-auto shrink-0 flex-col md:flex-row items-start mt-5 md:mt-0">
      <a href="/">Home</a>
      <a href="/posts">Stories</a>
      <a href="/dashboard/create">Write</a>
    </nav>
    <div class="auth-group flex md:flex gap-6 font-nunito w-full md:w-auto shrink-0 mt-5 md:mt-0">
  ...
  <main class="font-nunito">
    ...
    <section id="posts" class="mt-12 px-6 md:px-25">
      ...
      <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        <div class="blog-card rounded-lg overflow-hidden shadow-lg relative">
